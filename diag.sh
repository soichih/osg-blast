...
condor_status -constraints '(HAS_CVMFS_oasis_opensciencegrid_org =?= True) && (Memory >= 2000) && (Disk >= 200*1024*1024)' -format '%s ' GLIDEIN_ResourceName -format '%s\n' CVMFS_oasis_opensciencegrid_org_REVISION | sort | uniq
